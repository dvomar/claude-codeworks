---
name: mdv-obsidian-project-scope
description: Fáze 1 mapování libovolného projektu do Obsidian vaultu — CO systém umí (schopnosti), ne JAK to dělá. Fan-out průzkumných agentů po doménách, syntéza do propojených not. Použij při nástupu na neznámý projekt, při onboardingu, nebo když chybí přehled schopností. Spouštěj jako "/mdv-obsidian-project-scope", "zmapuj projekt do vaultu", "co ten systém vlastně umí".
