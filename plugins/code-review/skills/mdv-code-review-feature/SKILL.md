...
```
/mdv-code-review-feature <path> [path2 ...]
```

Examples:
```
/mdv-code-review-feature src/services/OrderService.cs
/mdv-code-review-feature src/services/UserService.cs src/api/UserEndpoint.cs
```
...
Check against the conventions from CLAUDE.md, `.claude/rules/` and `.claude/knowledge/`:
