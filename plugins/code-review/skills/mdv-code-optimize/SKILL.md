...
```
/mdv-code-optimize <path> [--focus performance|memory|readability|all]
```
...
Examples:
```
/mdv-code-optimize src/services/OrderService.cs
/mdv-code-optimize src/services/OrderService.cs --focus performance
```
